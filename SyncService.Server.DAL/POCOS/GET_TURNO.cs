...
namespace SyncService.Server.DAL.POCOS
{
    public partial class GET_TURNO
    {
        ...
        public virtual APP_BANDEJA APP_BANDEJA
        {
            get { return _aPP_BANDEJA; }
            set
            {
                if (!ReferenceEquals(_aPP_BANDEJA, value))
                {
                    var previousValue = _aPP_BANDEJA;
                    _aPP_BANDEJA = value;
                    FixupAPP_BANDEJA(previousValue);
                }
            }
        }
        private APP_BANDEJA _aPP_BANDEJA;
        ...
        private void FixupAPP_BANDEJA(APP_BANDEJA previousValue)
        {
            if (previousValue != null && ReferenceEquals(previousValue.GET_TURNO, this))
            {
                previousValue.GET_TURNO = null;
            }
    
            if (APP_BANDEJA != null)
            {
                APP_BANDEJA.GET_TURNO = this;
            }
        }
