...
{
    public partial class SyncServiceServerEntity : ObjectContext
    {
        public const string ConnectionString = "name=SyncServiceServerEntity";
        public const string ContainerName = "SyncServiceServerEntity";
    
        #region Constructors
    
        public SyncServiceServerEntity()
            : base(ConnectionString, ContainerName)
        {
            this.ContextOptions.LazyLoadingEnabled = true;
        }
    
        public SyncServiceServerEntity(string connectionString)
            : base(connectionString, ContainerName)
        {
            this.ContextOptions.LazyLoadingEnabled = true;
        }
    
        public SyncServiceServerEntity(EntityConnection connection)
        ...
        public ObjectSet<APP_BANDEJA> APP_BANDEJA
        {
            get { return _aPP_BANDEJA  ?? (_aPP_BANDEJA = CreateObjectSet<APP_BANDEJA>("APP_BANDEJA")); }
        }
        private ObjectSet<APP_BANDEJA> _aPP_BANDEJA;
        ...
        public ObjectResult<string> SP_GetMaxsServer(string jsonTable, string tblName)
        {
            ...
            return base.ExecuteFunction<string>("SP_GetMaxsServer", jsonTableParameter, tblNameParameter);
        }
