...
{
    public partial class REL_SIGNATARIO_EXTERNO
    {
        ...
        public virtual long IdSignatarioExterno
        {
            get;
            set;
        }
        ...
        {
            if (previousValue != null && previousValue.REL_SIGNATARIO_EXTERNO.Contains(this))
            {
                previousValue.REL_SIGNATARIO_EXTERNO.Remove(this);
            }
    
            if (CAT_DETERMINANTE != null)
            {
                if (!CAT_DETERMINANTE.REL_SIGNATARIO_EXTERNO.Contains(this))
                {
                    CAT_DETERMINANTE.REL_SIGNATARIO_EXTERNO.Add(this);
                }
        ...
        private void FixupGET_ASUNTO(GET_ASUNTO previousValue)
        {
            ...
            if (GET_ASUNTO != null)
            {
                if (!GET_ASUNTO.REL_SIGNATARIO_EXTERNO.Contains(this))
                {
                    GET_ASUNTO.REL_SIGNATARIO_EXTERNO.Add(this);
                }
