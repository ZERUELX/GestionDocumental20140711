...
namespace GestorDocument.ViewModel.Login
{
    public class UserLoginViewModel : ViewModelBase
    {
        ...
        public UserLoginViewModel(SesionModel sesion)
        {
            this.SesionRepository = new SesionRepository();
            this.Sesion = sesion;
            this.CloseSesion();
        ...
        public void CloseSesion() 
        {
            if (this.Sesion!=null)
            {
                this.Sesion.NoCerrarSesion = false;
                this.SesionRepository.UpdateSesion(this.Sesion);   
            }
        }
    }
}
