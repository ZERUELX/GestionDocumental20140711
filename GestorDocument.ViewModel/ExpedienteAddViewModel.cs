...
{
    public class ExpedienteAddViewModel : ViewModelBase
    {
        // ***************************** ***************************** *****************************
        // Repository.
        ...
        public bool CanSave()
        {
            ...
            {
                _CanSave = true;
                this._CheckSave = this._ExpedienteRepository.GetExpedienteAdd(this._Expediente);
        ...
        // ***************************** ***************************** *****************************
        // constructor
        public ExpedienteAddViewModel(ExpedienteViewModel ExpedienteViewModel)
        {
