...
{
    public class StatusAsuntoAddViewModel : ViewModelBase
    {
        // ***************************** ***************************** *****************************
        // Repository.
        ...
        public bool CanSave()
        {
            ...
            if ((!String.IsNullOrEmpty(this._StatusAsunto.StatusName)) && (this._StatusAsunto != null))
            {
                _CanSave = true;
                this._CheckSave = this._StatusAsuntoRepository.GetStatusAsuntoAdd(this._StatusAsunto);
        ...
        public void AttemptSave()
        {
            ...
            this._StatusAsuntoRepository.InsertStatusAsunto(this._StatusAsunto);
        ...
        // ***************************** ***************************** *****************************
        // constructor
        public StatusAsuntoAddViewModel(StatusAsuntoViewModel StatusAsuntoViewModel)
        {
            ...
            {
                IdStatusAsunto = new UNID().getNewUNID(),
                IsActive = true
            };
        }
    }
