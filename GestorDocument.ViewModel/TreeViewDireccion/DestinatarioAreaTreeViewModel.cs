...
{
    public class DestinatarioAreaTreeViewModel : ViewModelBase , IParentItem
    {
            ...
            if (this.Rol != null && this.Rol.Organigrama != null)
            {
                ...
                }).ToList().ForEach(o =>
                {
                    ...
                    temp.Add(
                            ...
                            {
                                Organigrama = this._OrganigramaRepository.GetOrganigramaID(new OrganigramaModel(){ IdJerarquia=(long)this._Rol.Organigrama.IdJerarquiaParent})
                            }
                        );

                    this.Children.Add(new DestinatarioItemViewModel(this)
                    {
                        CanOpenChild = (o.IdRol == this.Rol.IdRol) ? false : true,
                        Organigrama = o,
