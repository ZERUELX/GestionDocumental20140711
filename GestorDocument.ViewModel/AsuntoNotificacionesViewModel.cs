...
{
    public class AsuntoNotificacionesViewModel : ViewModelBase
    {
        ...
        private PantallaInicioViewModel viewModel;
        private int filtro;
        ...
        public void LoadInfoGrid()
        {
            ...
            (from p in this.Asuntos
             select p).ToList().ForEach(o => 
             {
                 if (o.Turno !=null)
                 {
                     o.Turno.Destinatario = this._DestinatarioRepository.GetSeguimientoDestinatarios(o.IdAsunto);    
                 }
